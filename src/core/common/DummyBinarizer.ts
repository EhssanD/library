...
/*namespace com.google.zxing.common {*/
   ...
   * @author Sean Owen
   */
  export default class DummyBinarizer extends Binarizer {

      private static LUMINANCE_BITS = 5;
      private static LUMINANCE_SHIFT = 8 - DummyBinarizer.LUMINANCE_BITS;
      private static LUMINANCE_BUCKETS = 1 << DummyBinarizer.LUMINANCE_BITS;
      ...
      public getBlackRow(y: number /*int*/, row: BitArray): BitArray /*throws NotFoundException*/ {
          ...
          const blackPoint = DummyBinarizer.estimateBlackPoint(localBuckets);
      ...
      public getBlackMatrix(): BitMatrix /*throws NotFoundException*/ {
          ...
          //     }
          // }
          const blackPoint = 1;//DummyBinarizer.estimateBlackPoint(localBuckets);
      ...
      private initArrays(luminanceSize: number /*int*/): void {
          ...
          for (let x = 0; x < DummyBinarizer.LUMINANCE_BUCKETS; x++) {
              buckets[x] = 0;
          }
      }
